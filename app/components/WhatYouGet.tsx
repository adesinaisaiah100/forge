export default function WhatYouGet() {
  return (
    <section id="what-you-get" className="relative overflow-hidden bg-background py-20 sm:py-32">
      <div className="mx-auto max-w-7xl px-6">
        
        {/* Header */}
        <div className="mx-auto max-w-2xl text-center">
          <h2 className="font-(family-name:--font-advent-pro) text-4xl font-bold tracking-tight text-heading sm:text-5xl">
        ...
        {/* Bento Grid */}
        <div className="mt-12 grid gap-4 sm:mt-16 sm:grid-cols-2 lg:grid-cols-3 lg:gap-8">
          
          {/* Card 1: Problem Statement */}
          <div className="group relative overflow-hidden rounded-3xl border border-white/60 bg-white p-6 shadow-sm transition-all hover:shadow-md sm:p-8">
            ...
            <h3 className="font-(family-name:--font-manrope) text-xl font-bold text-heading">Problem Statement</h3>
          ...
          <div className="group relative overflow-hidden rounded-3xl border border-white/60 bg-white p-6 shadow-sm transition-all hover:shadow-md sm:p-8">
            ...
            <h3 className="font-(family-name:--font-manrope) text-xl font-bold text-heading">Idea Evaluation</h3>
            <p className="mt-2 text-sm leading-relaxed text-body/70">
          ...
          <div className="group relative overflow-hidden rounded-3xl border border-white/60 bg-white p-6 shadow-sm transition-all hover:shadow-md sm:p-8">
            ...
            <h3 className="font-(family-name:--font-manrope) text-xl font-bold text-heading">MVP Feature List</h3>
            <p className="mt-2 text-sm leading-relaxed text-body/70">
          ...
          {/* Card 4: Pitch Deck */}
          <div className="group relative overflow-hidden rounded-3xl border border-white/60 bg-white p-6 shadow-sm transition-all hover:shadow-md sm:p-8 lg:col-span-2">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
              <div>
                ...
                <h3 className="font-(family-name:--font-manrope) text-xl font-bold text-heading">Structured Pitch Deck</h3>
          ...
          <div className="group relative overflow-hidden rounded-3xl border border-white/60 bg-white p-6 shadow-sm transition-all hover:shadow-md sm:p-8">
            ...
            <h3 className="font-(family-name:--font-manrope) text-xl font-bold text-heading">Execution Roadmap</h3>
            <p className="mt-2 text-sm leading-relaxed text-body/70">
        ...
        <div className="mt-24 flex justify-center">
             <div className="h-16 w-px bg-linear-to-b from-transparent via-primary/20 to-transparent"></div>
        </div>

        {/* Integrated CTA */}
        <div className="mx-auto mt-8 max-w-3xl text-center">
             <h2 className="font-(family-name:--font-advent-pro) text-4xl font-bold tracking-tight text-heading sm:text-6xl">
             ...
             <div className="mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row">
                 <a
                   href="/onboarding"
                   className="inline-flex h-14 min-w-50 items-center justify-center rounded-full bg-primary px-8 text-lg font-semibold text-white shadow-lg shadow-primary/25 transition-all hover:-translate-y-0.5 hover:bg-primary-hover hover:shadow-xl hover:shadow-primary/35"
                 >
